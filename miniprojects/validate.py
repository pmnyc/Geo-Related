...
if __name__ == "__main__":
    ...
    try:
        ...
        print("-" * 80)
        print("Flake8 failed. Consider cleaning up your Python code. (Machine-generated")
        print("files can be excluded from flake8 checking by starting them with the line")
        print("`# flake8: noqa`.)")
